...
void Sruba::obroc_z_dronem(MacierzOb Nowa_orientacja_drona)
{
    ...
    MacOrientacji = MacOrientacji * MacierzOb(Kat_obrotu_sruby, 'z');
    Kat_obrotu_sruby += 40;
}
...
void Sruba::przesun_z_dronem(Wektor<double,3> Nowy_sr_drona, MacierzOb Nowa_orientacja_drona)
{
 ...
 Sruba::Sruba(double WspX, double WspY, double WspZ, double WymX, double WymZ) : Graniastoslup(WspX, WspY, WspZ, WymX, WymZ) 
 {
     Orientacja_mocowania = MacierzOb(90, 'y');
     Kat_obrotu_sruby = 70;
